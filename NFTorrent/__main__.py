...
def main():
    parser = argparse.ArgumentParser('ton-nft-torrent')
    ...
    logs_args.add_argument('--logs-level', type=str, choices=['DEBUG', 'INFO', 'WARNING', 'ERROR', 'CRITICAL'], default='WARNING', help='Logging level')
